...
$GP -> MENU_ADMIN = array(
		...
		/*array("tab"=>"3",			"folder"=>"doctor", 		"name"=>"치료진관리",		"link"=> "/admin/doctor/dr_list.php?m_tab=3"),		*/
		array("tab"=>"4",			"folder"=>"member", 	"name"=>"회원관리",			"link"=> "/admin/member/mem_list.php?m_tab=4"),		
		array("tab"=>"6",			"folder"=>"nonpay", 		"name"=>"비급여관리",		"link"=> "/admin/nonpay/nonpay_list_new.php?m_tab=6"),	
...
$GP -> MENU_SUB_ADMIN['doctor'] = array(
	"치료진관리"   => array(
		array("tab"=>"1",	"title"=>"doctor1", "name"=>"치료진 정보",			"link"=>  "/admin/doctor/dr_list.php"),
		array("tab"=>"2",	"title"=>"doctor2", "name"=>"치료진 단체 정보",			"link"=>  "/admin/doctor/dg_list.php"),
	)
);
