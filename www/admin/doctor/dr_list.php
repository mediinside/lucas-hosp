...
<div class="Wrap"><!--// 전체를 감싸는 Wrap -->
		...
		<div class="btnWrap">
			...
			<button onClick="layerPop('ifm_reg','./dr_reg.php', '100%', 750)"; class="btnSearch btnRight">치료진 등록</button>
		</div>
