...
<table>
	...
	<tr>		
		...
		<td>
			...
			?>
				<p>
					<input type="text" class="txt" placeholder="아코디언 제목 입력" style="width:98%;margin:0 0 5px;" name="tti_ta_tit_<?=$j?>" id="tti_ta_tit_<?=$j?>" value="<?=$arr_ta_tit[$j]?>" />
					<textarea rows="3" cols="20" placeholder="아코디언 내용 입력" name="tti_ta_con_<?=$j?>" id="tti_ta_con_<?=$j?>"><?=$arr_ta_con[$j]?></textarea>
				</p>
			<?
						}
					}
