<table>
	...
	<tr>		
		...
		<td>
			...
			<p><input type="text" class="txt" placeholder="이미지 가로 크기 입력" name="tti_img_width" id="tti_img_width" value="<?=$tti_img_width?>" /></p>
			<p><textarea rows="3" cols="20" placeholder="텍스트 입력" name="tti_sub_text1" id="tti_sub_text1"><?=$tti_sub_text1?></textarea></p>
		</td>
		<td>
