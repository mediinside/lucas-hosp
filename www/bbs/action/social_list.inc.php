			...
			echo ("				
					<a href='" . $get_par . "'>
						<div class='socialcont'>
							<div class='img'>" . $img_src ."</div>
							<div class='tit'><p>${jb_title}</p></div>
							<div class='con'><p>${jb_content}</p><span class='socialmore' href='" . $get_par . "'>more</span></div>
						</div>
					</a>
				");
