      ...
      <tbody>
        <tr>
		 ...
		 <tr>
          ...
          <td><input type="text" class="txt w100" title="모집직종 입력" placeholder="모집직종 입력해 주세요." id="jb_etc1" name="jb_etc1"  value="<?=$jb_etc1;?>" /></td>
        </tr> 
         <tr>
          <th scope="row">마감일</th>
          <td>
          	<input type="text" class="txt w100" title="시작일 입력" placeholder="시작일을 입력해 주세요." id="jb_etc2" name="jb_etc2" value="<?=$jb_etc2;?>" />
          </td>
        </tr>
		 <tr>
          <th scope="row">직급</th>
          <td><input type="text" class="txt w100" title="모집직책 입력" placeholder="모집직책 입력해 주세요." id="jb_etc3" name="jb_etc3" value="<?=$jb_etc3;?>" /></td>
        </tr> 
		 <tr>
          <th scope="row">진행상태</th>
          <td>
			<input type="radio" title="상태 선택" name="jb_etc4" value="Y" <? if($jb_etc4 == "Y"){ echo "checked"; }?> />마감
			<input type="radio" title="상태 선택" name="jb_etc4" value="N" <? if($jb_etc4 == "N"){ echo "checked"; }?> />진행
		  </td>
        </tr> 
