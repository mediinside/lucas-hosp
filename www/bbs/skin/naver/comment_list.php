...
<script type="text/javascript">	
	...
	function comm_reply(jbc_idx, jb_idx, jb_code, jbc_group, jbc_step, jbc_depth, jbc_name, jbc_mb_id) {		
		...
		str += '<label>이름 : <input type="text" name="jbc_name" id="jbc_name" size="18" maxlength="30" value="<?=$check_name?>" class="txtInput"></label>';		
		str += '<label>비밀번호 : <input type="password" name="jbc_password" id="jbc_password" size="18" maxlength="50" class="txtInput"></label>';
	  str += '</p>';
		<?
			}else{
