  ...
  <div class="bbsWrite">
    <table>
      ...
      <tbody>
		...
		<tr>
          <th scope="row">연락처</th>
          <td><input type="text" class="txt w100" title="연락처 입력" placeholder="연락처를 입력해 주세요." id="jb_mobile" name="jb_mobile" value="<?=$jb_mobile?>" /></td>
        </tr>
        ...
        <tr>
          ...
          <td>           
			<?
              echo "<label><input type=\"checkbox\" name=\"jb_notice_check\" value=\"Y\" class='chk' ${notice_checked}>공지</label>";            
            ?>
          </td>
        </tr>
		<? } ?>
