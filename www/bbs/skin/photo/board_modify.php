...
<form name="frm_Board" id="frm_Board" action="<?=$get_par?>" method="post" enctype="multipart/form-data">
  ...
  <input type="hidden" name="before_front_file" id="before_front_file" value="<?=$jb_front_image;?>">
  <div class="bbsWrite">
    <table>
      ...
      <tbody>
		...
		<tr>
          ...
          <td>
			...
			<?
				if($jb_front_image != "") {
					echo  "<br>" . $jb_front_image;
					 echo " <input type=\"checkbox\" name=\"del_file_front\" value=\"Y\"> X";			
				} 
			?>
		  </td>
        </tr>
